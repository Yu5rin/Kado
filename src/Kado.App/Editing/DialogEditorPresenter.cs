...
public sealed class DialogEditorPresenter(Func<Window?> ownerProvider) : IEditorPresenter
{
    ...
    public void ShowSettings(Kado.Presentation.ViewModels.SettingsViewModel settings)
    {
    ...
    public void ShowWorkdayCalculator(
        Kado.Presentation.ViewModels.WorkdayCalculatorViewModel calculator)
    {
    ...
    public bool ConfirmDelete(string title) =>
        MessageBox.Show(
            ...
            "Kado", MessageBoxButton.OKCancel, MessageBoxImage.Warning,
