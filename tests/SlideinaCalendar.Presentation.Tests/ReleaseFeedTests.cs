...
public class ReleaseFeedTests
{
    private const string Typical = """
        {
          ...
          "assets": [
            {
              "name": "SlideinaCalendar-0.5.0-win-x64.exe",
              "size": 71662439,
              "digest": "sha256:ABCDEF0123456789",
              "browser_download_url":
                "https://github.com/Yu5rin/SlideinaCalendar/releases/download/v0.5.0/SlideinaCalendar.exe"
            }
          ]
        }
        """;
    ...
    public void 行き先が許されない応答は丸ごと断る()
    {
        var tampered = Typical.Replace(
            "https://github.com/Yu5rin/SlideinaCalendar/releases/download/v0.5.0/SlideinaCalendar.exe",
            "https://evil.example.com/SlideinaCalendar.exe");
    ...
    public void 実行ファイル以外は選ばない()
    {
        var zipOnly = Typical.Replace(
            "SlideinaCalendar-0.5.0-win-x64.exe", "SlideinaCalendar-0.5.0-win-x64.zip");
