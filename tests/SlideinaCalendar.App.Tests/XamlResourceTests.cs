...
namespace SlideinaCalendar.App.Tests;
...
public class XamlResourceTests
{
    ...
    private static string Locate()
    {
        ...
        {
            var candidate = Path.Combine(directory.FullName, "src", "SlideinaCalendar.App");
            if (Directory.Exists(candidate)) return candidate;

            directory = directory.Parent;
        }

        throw new DirectoryNotFoundException("src/SlideinaCalendar.App が見つかりません。");
    }
}
